...
import { g as getBaseUrl, F as FALLBACK_EVENT_SLUGS } from './slugs-BOXTUA_I.js';
...
const __namedExportsOrder = ['Default', 'WithoutParticipants', 'LimitedAvatars'];

export { Default, LimitedAvatars, WithoutParticipants, __namedExportsOrder, meta as default };
