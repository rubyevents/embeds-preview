...
const __namedExportsOrder = ['Default', 'CountriesTab', 'EventsTab', 'AchievementsTab', 'WithoutSections'];

export { AchievementsTab, CountriesTab, Default, EventsTab, WithoutSections, __namedExportsOrder, meta as default };
